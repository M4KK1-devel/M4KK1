...
void mkrn_main(uint64_t magic, uint64_t multiboot_addr)
{
    ...
    mkrn_console_write("=====================================\n");
    mkrn_console_write("    M4KK1 ARM Kernel Starting...\n");
    mkrn_console_write("=====================================\n");
    ...
    mkrn_console_write("M4KK1 ARM Kernel v0.2.0-multarch\n");
    mkrn_console_write("Architecture: ARM (32-bit)\n");
    ...
    mkrn_console_write("=====================================\n");
    mkrn_console_write("M4KK1 ARM Kernel Ready!\n");
    mkrn_console_write("=====================================\n");
...
{
    mkrn_console_write("Initializing ARM architecture...\n");

    m4k_arch_detect_features();

    mkrn_console_write("ARM architecture initialized\n");
}
