...
void mkrn_main(uint64_t magic, uint64_t multiboot_addr)
{
    ...
    mkrn_console_write("=====================================\n");
    mkrn_console_write("   M4KK1 ARM64 Kernel Starting...\n");
    mkrn_console_write("=====================================\n");
    ...
    mkrn_console_write("M4KK1 ARM64 Kernel v0.2.0-multarch\n");
    mkrn_console_write("Architecture: ARM64 (AArch64)\n");
    ...
    mkrn_console_write("  Architecture: ARM64\n");
    ...
    mkrn_console_write("=====================================\n");
    mkrn_console_write("M4KK1 ARM64 Kernel Ready!\n");
    mkrn_console_write("=====================================\n");
...
{
    mkrn_console_write("Initializing ARM64 architecture...\n");

    m4k_arch_detect_features();

    mkrn_console_write("ARM64 architecture initialized\n");
}
