...
void mkrn_main(uint64_t magic, uint64_t multiboot_addr)
{
    ...
    mkrn_console_write("=====================================\n");
    mkrn_console_write(" M4KK1 PowerPC Kernel Starting...\n");
    mkrn_console_write("=====================================\n");
    ...
    mkrn_console_write("M4KK1 PowerPC Kernel v0.2.0-multarch\n");
    mkrn_console_write("Architecture: PowerPC (64-bit)\n");
    ...
    mkrn_console_write("  Architecture: PowerPC\n");
    ...
    mkrn_console_write("=====================================\n");
    mkrn_console_write("M4KK1 PowerPC Kernel Ready!\n");
    mkrn_console_write("=====================================\n");
...
{
    mkrn_console_write("Initializing PowerPC architecture...\n");

    m4k_arch_detect_features();

    mkrn_console_write("PowerPC architecture initialized\n");
}
